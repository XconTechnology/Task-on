...
function ProjectCard({ project }: { project: Project }) {
  ...
  const teamSize = Math.floor(Math.random() * 8) + 2 // Mock team size
        ...
        <div className="space-y-4">
          ...
          <div>
            <div className="flex items-center justify-between mb-2">
              ...
              <span className="text-small font-medium text-gray-900">{progress}%</span>
            </div>
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-small text-gray-600">{teamSize} members</span>
            </div>
            <div className="flex items-center space-x-2">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex -space-x-2">
              {Array.from({ length: Math.min(teamSize, 4) }).map((_, i) => (
              ...
              {teamSize > 4 && (
                <div className="h-6 w-6 bg-gray-100 border-2 border-white rounded-full flex items-center justify-center">
                  <span className="text-extra-small text-gray-600">+{teamSize - 4}</span>
                </div>
              )}
            </div>
          </div>
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center space-x-8">
                <div className="text-center">
                  ...
                  <p className="text-medium font-semibold text-gray-900">{progress}%</p>
                </div>
                <div className="text-center">
                  <p className="text-small text-gray-600">Team</p>
                  <p className="text-medium font-semibold text-gray-900">{teamSize} members</p>
                </div>
                <div className="text-center">
