...
// Re-export components with better names
...
export const RechartsChartLegend = RechartsLegend
...
// Export the ResponsiveContainer for convenience
export const ResponsiveContainer = ({
  children,
  ...props
}: React.ComponentProps<typeof RechartsResponsiveContainer>) => (
  <RechartsResponsiveContainer width="100%" height="100%" {...props}>
    {children}
